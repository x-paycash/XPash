    ...
    public function ajax()
    {
        return datatables()
            ...
            ->editColumn('first_name', function ($admin)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/admin-user/edit/' . $admin->id) . '">'.$admin->first_name.'</a>' : $admin->first_name;
            })
            ->editColumn('last_name', function ($admin)
            {
                return (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_admin')) ?
                '<a href="' . url(Config::get('adminPrefix').'/admin-user/edit/' . $admin->id) . '">'.$admin->last_name.'</a>' : $admin->last_name;
            })
