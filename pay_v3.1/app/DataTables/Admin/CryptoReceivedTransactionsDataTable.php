    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($transaction)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/crypto-received-transactions/view/' . $transaction->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-eye-open" title="View"></i></a>&nbsp;' : '';
                return $view;
            })
