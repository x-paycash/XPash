...
class CryptoSentTransactionsDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            {
                $network_fee = (json_decode($transaction->cryptoapi_log->payload))->network_fee > 0 ?  (json_decode($transaction->cryptoapi_log->payload))->network_fee : 0.00000000;
            ...
            ->addColumn('action', function ($transaction)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/crypto-sent-transactions/view/' . $transaction->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-eye-open" title="View"></i></a>&nbsp;' : '';
                return $view;
            })
