    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('code', function ($dispute)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/dispute/discussion/' . $dispute->id) . '">'.$code.'</a>' : $code;
                return $codeWithLink;
            })
            ->addColumn('title', function ($dispute)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/dispute/discussion/' . $dispute->id) . '">'.$title.'</a>' : $title;
            ...
            ->editColumn('claimant_id', function ($dispute)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/users/edit/' . $dispute->claimant->id) . '">'.$claimant.'</a>' : $claimant;
            ...
            ->editColumn('defendant_id', function ($dispute)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/users/edit/' . $dispute->defendant->id) . '">'.$defendant.'</a>' : $defendant;
            ...
            ->editColumn('transaction_id', function ($dispute)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/transactions/edit/' . $dispute->transaction->id) . '" target="_blank">'.$transactionUuid.'</a>' : $transactionUuid;
