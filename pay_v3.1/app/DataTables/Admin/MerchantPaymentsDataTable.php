    ...
    public function ajax()
    {
        return datatables()
            ...
            ->editColumn('merchant_id', function ($merchant_payment)
            {
                ...
                // return $merchant;
                $merchantWithLink = (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_user')) ? '<a href="' . url(Config::get('adminPrefix').'/users/edit/' . $merchant_payment->merchant->user->id) . '">'.$merchant.'</a>' : $merchant;
            ...
            ->addColumn('action', function ($merchant_payment)
            {
                ...
                '<a href="' . url(Config::get('adminPrefix').'/merchant_payments/edit/' . $merchant_payment->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;' : '';
                return $edit;
            })
