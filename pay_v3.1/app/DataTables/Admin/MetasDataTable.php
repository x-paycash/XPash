...
class MetasDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        ->addColumn('action', function ($seo_metas)
        {
            ...
            $edit = (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_meta')) ? '<a href="'.url(Config::get('adminPrefix').'/settings/edit_meta/'.$seo_metas->id).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;' : '';
            return $edit;
        })
        ->make(true);
    }
