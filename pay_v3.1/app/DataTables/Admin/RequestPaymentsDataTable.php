    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('sender', function ($request_payment)
            {
                ...
                $senderWithLink = (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_user')) ? '<a href="' . url(Config::get('adminPrefix').'/users/edit/' . $request_payment->user->id) . '">'.$sender.'</a>' : $sender;
