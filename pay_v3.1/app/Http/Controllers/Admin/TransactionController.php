    ...
    */
    ...
    public function edit($id)
    {
        ...
        $data['transaction']          = $transaction          = Transaction::with([
            ...
            'mobilemoney:id,mobilemoney_name,merchant_code,holder_name',
            'withdrawal.withdrawal_detail:id,withdrawal_id,account_name,account_number,swift_code,bank_name,mobilemoney_id,mobile_number',
