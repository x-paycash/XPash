...
class ExchangeController extends Controller
{
    ...
    public function exchangeOfCurrency(Request $request)
    {
        ...
        {
            $rules      = ['amount' => 'required', 'currency_id' => 'required', 'from_currency_id' => 'required'];
            $fieldNames = ['amount' => 'Amount', 'currency_id' => 'To wallet Currency', 'from_currency_id' => 'From wallet currency'];
