...
class Deposit extends Model
{
     ...
     * 
     */
    public static function success($currencyId, $payment_method_id, $user_id, $sessionValue, $status="Success", $type="payment_gateway", $uuid = null, $fileId=null, $bankId=null)
    {
        ...
        $uuid    = empty($uuid) ? unique_code() : $uuid;
        $deposit                    = new self();
        $deposit->uuid              = $uuid;
