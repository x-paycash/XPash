...
class Transaction extends Model
{
    ...
    public static $transactionTypes           = [Deposit, Withdrawal, Transferred, Received, Exchange_From, Exchange_To, Request_From, Request_To, Payment_Sent, Payment_Received, Crypto_Sent, Crypto_Received, Crypto_Exchange_From, Crypto_Exchange_To, Fiat_Exchange_From, Fiat_Exchange_To];
