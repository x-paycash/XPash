...
function getCurrencyRate($from, $to)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://v6.exchangerate-api.com/v6/53d365026a270b77dbf2a36d/latest/'.$from,
        CURLOPT_RETURNTRANSFER => true,
        ...
        CURLOPT_HTTPHEADER => array(
            'Cookie: __cfduid=da0d87c1b6afd4cad771f7fbea2ff16831618988347'
        ),
    ));
    ...
    return $currencyList['conversion_rates'][$to];
}
...
if (!function_exists('isMiningReferralEnabled')) {
    function isMiningReferralEnabled()
    {
        return Setting::isMiningReferralEnabled();
    }
}
