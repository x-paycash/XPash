				...
				<form action="{{url('merchant/store')}}"  method="post" enctype="multipart/form-data" accept-charset="utf-8" id="merchant_add_form">
					...
					<div class="card">
						<div class="card-header">
							<h3>@lang('message.dashboard.button.new-merchant')</h3>
						</div>
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input value="{{ old('site_url') }}" class="form-control" name="site_url" id="site_url"  placeholder="http://www.example.com" type="text">
							...
							<div class="mt-5">
								<button type="submit" class="btn btn-grad col-12" id="merchant_create">
