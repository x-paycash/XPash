                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                <h4 class="form-text text-muted">*@lang('message.dashboard.crypto.send.create.amount-warning-text-4').</h4>
                            ...
                            <div class="mt-5">
                                <button type="submit" class="btn btn-grad col-12" id="crypto-send-submit-btn">
