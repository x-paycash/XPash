...
@section('content')
<!-- section_2fa_form -->
<section class="min-vh-100" id="section_2fa_form">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            ...
                            <form method="POST" class="form-horizontal" id="2fa_update">
                                ...
                                <div class="row mt-4">
                                    <div class="form-group col-md-12">
                                        <button type="submit" class="btn btn-grad col-12" id="2fa_submit">
...
<!-- section_2fa_verify -->
<section class="min-vh-100" id="section_2fa_verify" style="display: none;">
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="card">
...
<!-- section_google2fa -->
<section class="min-vh-100" id="section_google2fa" style="display: none;">
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                <div>
                                    <div style="text-align: center;">
                                        ...
                                        <button class="btn btn-grad mt-3 completeVerification">@lang('message.google2fa.proceed')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- section_2fa_otp -->
<section class="min-vh-100" id="section_2fa_otp" style="display: none;">
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                                ...
                                <form class="form-horizontal" method="POST" id="otp_form">
                                    ...
                                    <div class="form-group">
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-grad mt-3" id="verify_otp">@lang('message.2sa.verify')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
