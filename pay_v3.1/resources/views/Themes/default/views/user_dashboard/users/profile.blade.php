                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="text-center text-md-right">
                                                <button type="button" class="btn btn-grad text-left w-180p mt-2" data-toggle="modal"
                                                        data-target="#myModal">
                                    ...
                                    @else
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="uploadAvatar text-center text-md-right">
                                                    <button type="button" class="btn btn-grad w-180p text-left btn-border btn-sm editModal" data-toggle="modal" data-target="#editModal" style="margin-top: 10px;">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="row mt-4 mt-lg-0">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-center text-lg-right">
                                                <button type="button" class="btn btn-grad w-180p btn-border btn-sm mt-4 update-qr-code" id="qr-code-btn">
                                                    @lang('message.dashboard.button.update-qr-code')
                                                </button>
                                               <br>

                                                <a href="#" class="btn btn-grad w-180p btn-border btn-sm mt-3 mr-auto" id="print-qr-code-btn" style="display: none;">
                                                    <strong>
                                                        {{ __('Print QR Code') }}
                                                    </strong>
                                                </a>
