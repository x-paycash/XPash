                        ...
                        <div class="table-responsive">
                            @if($payoutSettings->count() > 0)
                                <table class="table recent_activity">
                                    <thead>
                                    <tr>
                                        <td class="pl-5"><strong>@lang('message.dashboard.payout.payout-setting.payout-type')</strong></td>
                                        <td><strong>@lang('message.dashboard.payout.payout-setting.account')</strong></td>
                                        <td class="pr-5 text-right"><strong>@lang('message.dashboard.payout.payout-setting.action')</strong></td>
                                    </tr>
                                    </thead>
                                    <tbody>
