                        ...
                        <div class="col-xl-10">
                            ...
                            <div class="bg-secondary mt-5 shadow p-35">
                                <div>
                                    ...
                                    <p class="text-center font-weight-600 mt-2">@lang('message.dashboard.deposit.deposit-amount') : {{  moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal)) }}</p>
