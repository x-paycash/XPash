                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            ...
                            <div class="bg-secondary rounded mt-5 shadow p-35">
								<div>
									<p>
										@lang('message.dashboard.exchange.confirm.exchanging')
										<strong>{{ $fromCurrency->code }}
										</strong>
									...
									<p>
										...
										&nbsp;<strong>1 {{$fromCurrency->code}} </strong> = <strong>{{ ($transInfo['dCurrencyRate']) }} {{ $transInfo['currCode'] }}</strong>
									</p>
