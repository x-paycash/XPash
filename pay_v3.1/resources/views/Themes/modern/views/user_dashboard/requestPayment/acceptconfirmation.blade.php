                            ...
                            <div class="bg-secondary rounded mt-5 shadow p-35">
								<div>
									...
									<div class="d-flex justify-content-between">
										...
										<div><p>{{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['fee'])) }}</p></div>
									</div>
									<hr class="my-2" />
			
									<div class="d-flex justify-content-between">
										<div><p class="font-weight-600">@lang('message.dashboard.confirmation.total')</p></div>
										<div><p class="font-weight-600">{{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['totalAmount'])) }}</p></div>
									</div>
