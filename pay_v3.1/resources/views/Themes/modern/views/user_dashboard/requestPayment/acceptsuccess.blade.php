						...
						<div class="col-xl-10">
							...
							<div class="bg-secondary rounded mt-5 shadow p-35">
								<div>
                                    ...
                                    <p class="text-center mt-2">@lang('message.dashboard.send-request.request.success.accept-amount') : {{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['amount'])) }}</p>
