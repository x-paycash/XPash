                        ...
                        <td>
                            <table style="margin-top:20px; width:300px;">
                                ...
                                <tr style="padding-bottom:10px;">
                                    ...
                                    <td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transaction->currency->symbol,  $network_fee) }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transaction->currency->symbol, (number_format($transaction->total-$network_fee, '8', '.', ''))) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
