<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li {{ isset($list_menu) &&  $list_menu == 'flexpay' ? 'class=active' : ''}} >
        <a data-spinner="true" href='{{ url(\Config::get('adminPrefix').'/settings/payment-methods/flexpay/'.$currency->id) }}'>Mobile Money</a>
      </li>

      <li {{ isset($list_menu) &&  $list_menu == 'mobile-money' ? 'class=active' : ''}} >
        <a data-spinner="true" href='{{ url(\Config::get('adminPrefix').'/settings/payment-methods/mobile-money/'.$currency->id) }}'>Mobile Money Manual</a>
      </li>
    </ul>
  </div>
</div>
