...
<div class="box box-default">
	<div class="box-body">
		<div class="d-flex justify-content-between">
			<div>
				<div class="top-bar-title padding-bottom pull-left">Crypto Sent Transaction Details</div>
			</div>
                                ...
                                <div class="panel-body">
                                    <div class="mt-4 p-4 bg-secondary rounded shadow">
                                        ...
                                        <div class="form-group total-deposit-feesTotal-space">
                                            <label class="control-label col-sm-6" for="fee">Network Fees
                                            </label>
                                            ...
                                            <div class="col-sm-6">
                                                <p class="form-control-static">
                                                    {{ moneyFormat($transaction->currency->symbol, isset($network_fee) ? $network_fee : 0.00000000) }}
                                                </p>
                                            </div>
                                        </div>
