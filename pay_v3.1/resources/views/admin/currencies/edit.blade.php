  ...
  <div class="row">
      <div class="col-md-12">
          <div class="box box-info">
              ...
              <form action="{{ url(\Config::get('adminPrefix').'/settings/edit_currency/'.$result->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="edit_currency_form">
                  @csrf
