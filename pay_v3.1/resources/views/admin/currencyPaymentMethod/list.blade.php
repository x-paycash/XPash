			...
			<div class="box box-info">
				<div class="box-header with-border text-center">
					<h3 class="box-title">
						...
						@elseif($list_menu == 'mobile-money')
						{{ "Mobile Money Manual" }} Settings
				...
				<form action='{{url(\Config::get('adminPrefix').'/settings/payment-methods/update-paymentMethod-Credentials')}}' class="form-horizontal" method="POST" id="currencyPaymentMethod_form">
					...
					<div class="box-body">
						...
						@elseif ($list_menu == 'flexpay')
							<!-- Flexpay - Merchant Code -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flexpay[merchant_code]">Merchant Code</label>
								<div class="col-sm-5">
									<input class="form-control flexpay[merchant_code]" name="flexpay[merchant_code]" type="text" placeholder="Flexpay Merchant Code"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->merchant_code : '' }}" id="flexpay_merchant_code">
									@if ($errors->has('flexpay[merchant_code]'))
									<span class="help-block">
										<strong>{{ $errors->first('flexpay[merchant_code]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- Flexpay - Authorization token -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flexpay[authorization_token]">Authorization Token</label>
								<div class="col-sm-5">
									<input class="form-control flexpay[authorization_token]" name="flexpay[authorization_token]" type="text" placeholder="Flexpay Merchant Authorization Token"
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->authorization_token : '' }}" id="flexpay_authorization_token">
									@if ($errors->has('flexpay[authorization_token]'))
									<span class="help-block">
										<strong>{{ $errors->first('flexpay[authorization_token]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<!-- Flexpay - processing_time -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">Processing Time (days)</label>
								<div class="col-sm-5">
									<input class="form-control processing_time" name="processing_time" type="text" placeholder="Flexpay Processing Time"
									value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
							...
							<!-- Flexpay - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="flexpay_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="flexpay_status" id="flexpay_status">
										<option value=''>Select Status</option>
										<option value='Active' {{ isset($currencyPaymentMethod->activated_for) && $currencyPaymentMethod->activated_for == json_encode(['deposit' => '']) ? 'selected':"" }}>Active</option>
										<option value='Inactive' {{ isset($currencyPaymentMethod->activated_for) && $currencyPaymentMethod->activated_for == json_encode(['' => '']) ? 'selected':"" }}>Inactive</option>
									</select>
				...
				@endif
				@if ($list_menu == 'mobile-money')
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<button data-toggle="modal" data-target="#addMobileMoneyModal" id="addMobileMoneyBtn" style="margin-bottom: 20px;margin-left: 10px;" class="btn btn-success btn-flat pull-left" type="button">
								<span class="fa fa-plus"> &nbsp;</span>Add MobileMoney
							</button>
				...
				@endif
				<!-- addMobileMoneyModal Modal-->
				<div class="modal fade" id="addMobileMoneyModal" role="dialog">
					<div class="modal-dialog modal-lg">
						<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header" style="display: block;">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title text-center">Add MobileMoney Details</h4>
							</div>
				
							<form id="addMobileMoneyForm" method="post" enctype="multipart/form-data">
										...
										<div class="col-md-12">
											...
											<div class="col-md-5">
												<div class="form-group">
													...
													<input name="holder_name" id="holder_name" class="form-control">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input name="mobilemoney_name" id="mobilemoney_name" class="form-control">
												</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>MobileMoney Logo</label>
													<input type="file" name="mobilemoney_logo" id="mobilemoney_logo" class="form-control input-file-field">
													<div class="clearfix"></div>
													<small class="form-text text-muted"><strong>{{ allowedImageDimension(120,80) }}</strong></small>
													<div class="preview_mobilemoney_logo">
														<img src="{{ url('public/uploads/userPic/default-image.png') }}" width="120" height="80" id="mobilemoney-demo-logo-preview"/>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="modal-footer">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-2"></div>
											<div class="col-md-4">
												<button type="submit" class="btn btn-primary btn-flat pull-right" id="mobile_money_submit_btn">Submit</button>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="modal fade" id="editMobileMoneyModal" role="dialog">
					<div class="modal-dialog modal-lg">
						<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header" style="display: block;">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title text-center">Edit MobileMoney Details</h4>
							</div>
				
							<form id="editMobileMoneyForm" method="post">
								{{csrf_field()}}
				
								<input type="hidden" name="mobilemoney_id" id="mobilemoney_id">
								<input type="hidden" name="mobile_money_file_id" id="mobile_money_file_id">
								<input type="hidden" name="edit_mobile_money_currency_id" id="edit_mobile_money_currency_id">
								<input type="hidden" name="edit_mobile_money_paymentMethod" id="edit_mobile_money_paymentMethod">
								<input type="hidden" name="currencyMobileMoneyPaymentMethodId" id="currencyMobileMoneyPaymentMethodId">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-5">
												<div class="form-group">
													<label>Merchant Name</label>
													<input name="edit_holder_name" id="edit_holder_name" class="form-control">
												</div>
												<div class="form-group">
													<label>Merchant Code</label>
													<input name="edit_merchant_code" id="edit_merchant_code" class="form-control">
												</div>
												<div class="form-group">
													<label>Network</label>
													<input name="edit_mobilemoney_name" id="edit_mobilemoney_name" class="form-control">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>MobileMoney Logo</label>
													<input type="file" name="edit_mobile_money_logo" id="edit_mobile_money_logo" class="form-control input-file-field">
													<div class="clearfix"></div>
													<small class="form-text text-muted"><strong>{{ allowedImageDimension(120,80) }}</strong></small>
													<div class="preview_edit_mobile_money_logo"></div>
												</div>
								...
								<div class="modal-footer">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-2"></div>
											<div class="col-md-4">
												<button type="submit" class="btn btn-primary btn-flat pull-right" id="edit_mobile_money_submit_btn">Update</button>
											</div>
										</div>
									</div>
								</div>
...
<script src="{{ asset('public/dist/js/mobile-money.js') }}"></script>
...
<script type="text/javascript">
    ...
    $('#currencyPaymentMethod_form').validate({
        rules: {
			...
			"flexpay[authorization_token]": {
				required: true,
			},
			"flexpay[merchant_code]": {
				required: true,
			},
			flexpay_status: {
				required: true,
    ...
    $(document).ready(function() {
		...
		$('#addMobileMoneyModal').on('hidden.bs.modal', function (e) {
			$('#addMobileMoneyForm').validate().resetForm();
			$('#addMobileMoneyForm').find('.error').removeClass('error');
			$('#mobile_money_submit_btn').prop('disabled',false);
			$('#mobilemoney_logo').val('');
			$('#mobilemoney-demo-logo-preview').attr({src: '{{ url('public/uploads/userPic/default-image.png') }}'});
		});

		$('#editMobileMoneyModal').on('hidden.bs.modal', function (e) {
			$('#editMobileMoneyModal').validate().resetForm();
			$('#editMobileMoneyModal').find('.error').removeClass('error');
			$('#edit_mobile_money_submit_btn').prop('disabled',false);
			$('#edit_mobile_money_logo').val('');
			$('#preview_edit_mobile_money_logo').attr({src: '{{ url('public/uploads/userPic/default-image.png') }}'});
		});
    });
			...
			success:function(data)
			{
				if (data.flag == true) {
					if (data.methodTitle == "Bank") {
						...
						$('#bank_body').html(tr);
					} else if (data.methodTitle == "MobileMoney") {
						var tr = '';
				...
				if(data.status == 200) {
					...
					$('#flexpay_merchant_code').val(JSON.parse(data.currencyPaymentMethod.method_data).merchant_code);
					$('#flexpay_authorization_token').val(JSON.parse(data.currencyPaymentMethod.method_data).authorization_token);
					...
					$('#flexpay_merchant_code').val('');
					$('#flexpay_authorization_token').val('');
					$('#flexpay_status').val('Inactive');
				}
			},
