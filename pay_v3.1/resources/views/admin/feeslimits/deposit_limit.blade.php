      ...
      <div class="box box-info">
        ...
        <form action='{{url(\Config::get('adminPrefix').'/settings/feeslimit/update-deposit-limit')}}' class="form-horizontal" method="POST" id="deposit_limit_form">
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse{{ $method->id }}">
                          @if (isset($method->name) && $method->name == 'Mts')
                            {{ getCompanyName() }}
                          @elseif ($method->name == 'Flexpay')
                            {{ 'Mobile Money' }}
                          @elseif ($method->name == 'MobileMoney')
                            {{ 'Mobile Money Manual' }}
                          @else
                            {{ $method->name }}
                          @endif</a>
          ...
          <div class="box-footer">
              <a href="{{  url(\Config::get('adminPrefix')."/settings/currency") }}" class="btn btn-danger btn-flat">Cancel</a>
