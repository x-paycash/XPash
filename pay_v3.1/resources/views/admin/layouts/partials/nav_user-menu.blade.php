<li class="dropdown user user-menu">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="user-footer">
            <div class="pull-left">
                <a href="{{ url(\Config::get('adminPrefix').'/profile') }}" class="btn btn-default btn-flat">Profile</a>
            </div>
            <div class="pull-right">
                {{-- <a href="{{URL::to('/')}}/admin/adminlogout" class="btn btn-default btn-flat">Sign out</a> --}}
                <a href="{{ url(\Config::get('adminPrefix').'/adminlogout') }}" class="btn btn-default btn-flat">Sign out</a>
            </div>
        </li>
    </ul>
</li>
