          ...
          <div class="row">
            ...
            <div class="col-md-2">
              @if(Common::has_permission(Auth::guard('admin')->user()->id, 'manage_page'))
                ...
                <a href="{{  url(\Config::get('adminPrefix')."/settings/pages") }}" class="btn btn-block btn-default btn-flat btn-border-orange">Pages</a>
                </div>
              @endif
            </div>
          </div>
      ...
      <div class="box-body">
        ...
        <form action="{{url(\Config::get('adminPrefix').'/settings/page/update')}}" method="post" id="page" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="box-footer">
            <a href="{{  url(\Config::get('adminPrefix')."/settings/pages") }}" class="btn btn-theme-danger">Cancel</a>
