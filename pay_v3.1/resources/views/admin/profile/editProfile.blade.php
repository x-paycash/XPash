            ...
            <div class="nav-tabs-custom">
                <div class="tab-content">
                    <div class="box-body box-profile">
                        ...
                        <a class="btn btn-primary btn-block" href='{{  url(\Config::get('adminPrefix')."/change-password")}}'><b>Change Password</b></a>
                    </div>

                    <div>
                        <form action='{{  url(\Config::get('adminPrefix')."/update-admin/$admin_id") }}' method="POST" class="form-horizontal" enctype="multipart/form-data" id="profile_form">
                            {!! csrf_field() !!}
