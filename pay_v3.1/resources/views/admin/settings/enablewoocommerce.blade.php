      ...
      <div class="col-md-9">
          <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Generate Woocommerce Brand</h3>
                ...
                {!! csrf_field() !!}
                  ...
                  <div class="box-body">
                    ...
                    @else
                      ...
                      <div class="form-group">
                          <label for="plugin_brand" class="col-sm-3 control-label">Plugin Brand</label>
                          <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label for="plugin_uri" class="col-sm-3 control-label">Plugin URI</label>
                          <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label for="plugin_author" class="col-sm-3 control-label">Plugin Author</label>
                          <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label for="plugin_author_uri" class="col-sm-3 control-label">Plugin Author URI</label>
                          <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label for="plugin_base_url" class="col-sm-3 control-label">Application Base URL</label>
                          <div class="col-sm-6">
                      ...
                      <div class="form-group">
                          <label for="plugin_description" class="col-sm-3 control-label">Plugin Description</label>
                          <div class="col-sm-6">
