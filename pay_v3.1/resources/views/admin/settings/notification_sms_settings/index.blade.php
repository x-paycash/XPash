        ...
        <div class="box box-info">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="tabs">
                    ...
                    {{-- <li class="active"><a href="{{ url(\Config::get('adminPrefix').'/settings/notification-settings/sms') }}">SMS Notification Settings</a></li> --}}
                </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="margin-top:10px">
                                                <a href="{{ url(\Config::get('adminPrefix').'/settings/notification-types') }}" class="btn btn-danger btn-flat">Cancel</a>
