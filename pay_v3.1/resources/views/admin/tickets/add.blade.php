        ...
        <form id="add_ticket_form" class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/tickets/store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-theme pull-right" id="create_ticket"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="create_ticket_text">Add</span></button>
                </div>
