    ...
    <div class="box-body">
        ...
        <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/tickets/update') }}" method="POST" id="edit_ticket_form">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <a id="cancel_anchor" class="btn btn-theme-danger pull-left" href="{{ url(\Config::get('adminPrefix').'/tickets/list') }}">Cancel</a>
                    <button type="submit" class="btn btn-theme pull-right" id="update_ticket"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="update_ticket_text">Update</span></button>
                </div>
