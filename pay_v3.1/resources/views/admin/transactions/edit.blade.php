                                                ...
                                                {{-- User --}}
                                                    <div class="form-group">
                                                            @if($transaction->transaction_type_id == Deposit
                                                                ...
                                                                || $transaction->transaction_type_id == Payment_Received || $transaction->transaction_type_id == Referral_Award)
                                                        ...
                                                        @php
                                                            ...
                                                            if (config('referral.is_active')) {
                                                                array_push($transactionTypeName, Referral_Award);
                                                            }
                                                        @endphp
                                                ...
                                                {{-- Receiver --}}
                                                    <div class="form-group">
                                                        @if($transaction->transaction_type_id == Deposit
                                                                ...
                                                                || $transaction->transaction_type_id == Referral_Award)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            @if (!config('crypto_exchange.is_active') && $transaction->transaction_type_id != Crypto_Sent && $transaction->transaction_type_id != Crypto_Received && !(config('referral.is_active') && $transaction->transaction_type_id == Referral_Award))
                                                                @if (!isset($transaction->refund_reference))
                                                                    <div class="col-md-4">
                                                                        <button type="submit" class="btn btn-theme pull-right" id="request_payment">
                                                                            <i class="spinner fa fa-spinner fa-spin"></i> <span id="request_payment_text">Update</span>
