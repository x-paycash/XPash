                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            ...
                            <div style="float: right;">
                                <form action="{{ url(\Config::get('adminPrefix').'/users/deposit/crypto/receive/success') }}" style="display: block;" method="POST" accept-charset="UTF-8" id="admin-user-crypto-receive-confirm" novalidate="novalidate">
...
<script type="text/javascript">
    ...
    function cryptoReceiveConfirmBack()
    {
        ...
        window.location.replace(SITE_URL+'/'+ADMIN_PREFIX+`/users/crypto/receive/${'{{ $user_id }}'}`);
    }
