                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            ...
                            <div style="float: right;">
                                <form action="{{ url(\Config::get('adminPrefix').'/users/deposit/crypto/send/success') }}" style="display: block;" method="POST" accept-charset="UTF-8" id="admin-user-crypto-send-confirm" novalidate="novalidate">
...
<script type="text/javascript">
    ...
    function cryptoSendConfirmBack()
    {
        ...
        window.location.replace(SITE_URL+'/'+ADMIN_PREFIX+`/users/crypto/send/${'{{ $user_id }}'}`);
    }
