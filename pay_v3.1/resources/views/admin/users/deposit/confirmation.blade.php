                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            ...
                            <div style="float: right;">
                                <form action="{{ url(\Config::get('adminPrefix').'/users/deposit/storeFromAdmin') }}" style="display: block;" method="POST" accept-charset="UTF-8" id="admin-user-deposit-confirm" novalidate="novalidate">
