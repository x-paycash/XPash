        ...
        <div class="col-md-5">
            <div class="pull-right">
                @if(Common::has_permission(auth()->guard('admin')->id(),'view_deposit'))
                    ...
                    &nbsp;&nbsp;&nbsp;
                @endif
                <a style="margin-top: 15px;" href="{{ url(\Config::get('adminPrefix').'/users/withdraw/create/'.$users->id) }}" class="btn btn-theme">Payout</a>
                &nbsp;&nbsp;&nbsp;
                ...
                @if ($getUserWalletCryptoapiLogs->count() > 0 && $getCurrenciesPreference->value == "fiat_and_crypto")
                    <!-- Crypto Send -->
                    <a style="margin-top: 15px;" href="{{ url(\Config::get('adminPrefix').'/users/crypto/send/'.$users->id) }}" class="btn btn-theme">Crypto Send</a>
                    &nbsp;&nbsp;&nbsp;
                    <!-- Crypto Receive -->
                    <a style="margin-top: 15px;" href="{{ url(\Config::get('adminPrefix').'/users/crypto/receive/'.$users->id) }}" class="btn btn-theme">Crypto Receive</a>
                @endif
