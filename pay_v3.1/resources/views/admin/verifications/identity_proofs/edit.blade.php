...
<section class="min-vh-100">
    <div class="my-30">
        <div class="row">
            <form action="{{ url(\Config::get('adminPrefix').'/identity-proofs/update') }}" class="form-horizontal" id="deposit_form" method="POST">
                {{ csrf_field() }}
                <!-- Page title start -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2"><a id="cancel_anchor" class="btn btn-theme-danger pull-left" href="{{ url(\Config::get('adminPrefix').'/identity-proofs') }}">Cancel</a></div>
                                                    <div class="col-md-4">
                                                        <button type="submit" class="btn btn-primary pull-right" id="deposits_edit">
