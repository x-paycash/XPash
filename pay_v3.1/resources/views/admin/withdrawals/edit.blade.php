            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @if ($withdrawal->status)
                        <h4 class="text-left">Status : @if ($withdrawal->status == 'Success')<span class="text-green">Success</span>
                            @endif
                            @if ($withdrawal->status == 'Pending')<span
                                    class="text-blue">Pending</span>@endif
                            @if ($withdrawal->status == 'Blocked')<span
                                        ...
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($withdrawal->payment_method)
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control"
                                                        name="payment_method"
                                                        value="{{ $withdrawal->payment_method->name == 'Mts' ? getCompanyName() : $withdrawal->payment_method->name }}">
                                                    <div class="col-sm-9">
                                                        <p class="form-control-static">
                                            ...
                                            @if (isset($withdrawal->withdrawal_detail))
                                                @if ($withdrawal->payment_method->name == 'Bank')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control"
                                                            name="bank_name"
                                                            value="{{ $withdrawal->withdrawal_detail->bank_name }}">
                                                        <div class="col-sm-9">
                                                            <p class="form-control-static">
                                        ...
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            @if ($withdrawal->amount)
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <p class="form-control-static">
                                                            {{ moneyFormat($withdrawal->currency->symbol, formatNumber($withdrawal->amount)) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-group total-deposit-feesTotal-space">
                                                    ...
                                                    <span>
                                                        <small class="transactions-edit-fee">
                                                            @if (isset($transaction))
                                                                ...
                                                                +
                                                                {{ formatNumber($withdrawal->charge_fixed) }})
                                                            @else
                                                                ({{ 0 }}%+{{ 0 }})
                                                            @endif
                                                        </small>
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="form-control-static">
                                                        {{ moneyFormat($withdrawal->currency->symbol, formatNumber($feesTotal)) }}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            @if (isset($total))
                                                <div class="form-group total-deposit-space">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <p class="form-control-static">
                                                            {{ moneyFormat($withdrawal->currency->symbol, formatNumber($total)) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
