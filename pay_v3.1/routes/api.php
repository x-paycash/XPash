...
Route::group(['namespace' => 'Api', 'middleware' => ['check-authorization-token']], function ()//bug-fixed-pm-v2.7
{
    ...
    Route::get('deposit/flexpay-make-payment', 'DepositMoneyController@flexpayMakePayment');
    ...
    Route::get('get-withdraw-mobile-networks', 'PayoutSettingController@availablenetworks');
