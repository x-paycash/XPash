...
// Flexpay callback
Route::match(['get', 'post'], 'confirm-flexpay', 'Users\DepositController@confirmFlexpay');
...
Route::group(['prefix' => Config::get('adminPrefix'), 'namespace' => 'Admin', 'middleware' => ['guest:admin', 'locale', 'ip_middleware']], function ()
{
    ...
    Route::match(array('GET', 'POST'), 'users/deposit/create/{id}', 'UserController@eachUserDeposit')->middleware('permission:edit_deposit');
    ...
    Route::match(array('GET', 'POST'), 'addons', 'AddonController@index');
    ...
    Route::group(['middleware' => ['check-enabled-currencies-preference']], function ()
    {
        ...
        Route::post('settings/payment-methods/add-mobile-money', 'CurrencyPaymentMethodController@addMobileMoney');
        Route::post('settings/payment-methods/update-mobile-money', 'CurrencyPaymentMethodController@updateMobileMoney');
        Route::post('settings/payment-methods/delete-mobile-money', 'CurrencyPaymentMethodController@deleteMobileMoney');
        Route::post('settings/payment-methods/get-mobilemoney-CpmId', 'CurrencyPaymentMethodController@getMobileMoneyCpmId');
});
